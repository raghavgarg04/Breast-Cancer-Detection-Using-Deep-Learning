...
# Load DenseNet121 pre-trained model without top (fully connected) layers
weights_path = '/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 3(DenseNet121)/densenet121_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
model_checkpoint = ModelCheckpoint('/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 2(DenseNet121)/best_model.h5', save_best_only=True, monitor='val_loss', mode='min')
...
# Load the best model
model.load_weights('/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 2(DenseNet121)/best_model.h5')
...
model.save('/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 3(DenseNet121)/breast_cancer_cnn_model.h5')
