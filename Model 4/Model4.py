...
# Load InceptionV3 pre-trained model without top (fully connected) layers
weights_path = '/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 4(Inception)/inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
model_checkpoint = ModelCheckpoint('/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 4(Inception)/best_model.h5', save_best_only=True, monitor='val_loss', mode='min')
...
history = model.fit(
    ...
    callbacks=[early_stop, model_checkpoint, reduce_lr, learning_rate_scheduler]
)

# Load the best model
model.load_weights('/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 4(Inception)/best_model.h5')
...
model.save('/Users/piyushgoyal/Desktop/Project-Research Paper/Model - 4(Inception)/breast_cancer_cnn_model.h5')
